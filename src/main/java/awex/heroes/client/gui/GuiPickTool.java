...
public abstract class GuiPickTool extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int i = 0; i < recentlyUsed.size(); ++i)
        {
            ...
            {
                Color color = new Color(0x414041);
            ...
            mc.renderEngine.bindTexture(awex.heroes.helper.TextureHelper.getTool(s.toLowerCase()));
            ...
            GL11.glTranslatef(-displayX, -displayY, 0);
            drawTexturedModalRect(displayX, displayY, 16, 64, 16, 64);
            GL11.glPopMatrix();
            scale = 0.5F + 0.0625F;
            GL11.glPushMatrix(); // gui size
