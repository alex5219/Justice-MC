...
public class EntityNumber extends Entity implements IEntityAdditionalSpawnData {
    protected int age;
    public float damage;
    protected int speed;

    public EntityNumber(World world) {
        super(world);
    }

    public EntityNumber(World world, float damage, double x, double y, double z) {
        super(world);
