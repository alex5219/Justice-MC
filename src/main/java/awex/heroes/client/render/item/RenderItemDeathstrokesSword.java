...
public class RenderItemDeathstrokesSword implements IItemRenderer {
    private ResourceLocation texture = new ResourceLocation("fiskheroes", "textures/models/prometheus_sword.png");
    private ModelKatana model = new ModelKatana();

    public RenderItemDeathstrokesSword() {
    }
