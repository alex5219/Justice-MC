...
public class HeroJohnStewart extends Hero implements IWill, IAiming, IHovering {
    public HeroJohnStewart() {
    }
    ...
    public void getAttributeModifiers(IAttributeContainer attributes, ItemStack itemstack) {
        ...
        attributes.add(SHAttributes.PUNCH_DAMAGE, 4.5D, 0);
        attributes.add(SHAttributes.SWORD_DAMAGE, 7.5D, 0);
        attributes.add(SHAttributes.ATTACK_DAMAGE, 6.1D, 1);
    }
