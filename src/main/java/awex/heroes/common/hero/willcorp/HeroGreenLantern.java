...
public class HeroGreenLantern extends Hero implements IWill, IAiming, IHovering {
    public HeroGreenLantern() {
    }

    public void init() {
        this.helmet = new ItemLanternArmor(this, ItemHeroArmor.ArmorType.MASK);
    ...
    public void getAttributeModifiers(IAttributeContainer attributes, ItemStack itemstack) {
        ...
        attributes.add(SHAttributes.ATTACK_DAMAGE, 5.0D, 1);
    }
