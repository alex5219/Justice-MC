...
public class HeroJessicaCruz extends Hero implements IWill, IAiming, IHovering {
    public HeroJessicaCruz() {
    }
    ...
    public void getAttributeModifiers(IAttributeContainer attributes, ItemStack itemstack) {
        ...
        attributes.add(SHAttributes.PUNCH_DAMAGE, 4.75D, 0);
        attributes.add(SHAttributes.SWORD_DAMAGE, 7.1D, 0);
