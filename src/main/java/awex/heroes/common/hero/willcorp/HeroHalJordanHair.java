...
import awex.heroes.common.items.ItemSpecialLantern;
...
public class HeroHalJordanHair extends Hero implements IWill, IAiming, IHovering {
    public HeroHalJordanHair() {
    }

    public void init() {
        this.helmet = new ItemSpecialLantern(this, ItemHeroArmor.ArmorType.HEAD);
        this.chestplate = new ItemSpecialLantern(this, ItemHeroArmor.ArmorType.TORSO);
        this.leggings = new ItemSpecialLantern(this, ItemHeroArmor.ArmorType.LEGS);
        this.boots = new ItemSpecialLantern(this, ItemHeroArmor.ArmorType.BOOTS);
    }
    ...
    public void getAttributeModifiers(IAttributeContainer attributes, ItemStack itemstack) {
        ...
        attributes.add(SHAttributes.PUNCH_DAMAGE, 9.8D, 0);
        attributes.add(SHAttributes.SWORD_DAMAGE, 9.4D, 0);
        attributes.add(SHAttributes.ATTACK_DAMAGE, 8.5D, 1);
    }
