...
public class HeroKilowog extends Hero implements IWill, IAiming, IHovering {
    public HeroKilowog() {
    }
    ...
    public void getAttributeModifiers(IAttributeContainer attributes, ItemStack itemstack) {
        ...
        attributes.add(SHAttributes.PUNCH_DAMAGE, 7.5D, 0);
        attributes.add(SHAttributes.SWORD_DAMAGE, 5.5D, 0);
